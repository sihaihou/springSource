...
public class BeanDefinitionParserDelegate {
	...
	public BeanDefinitionHolder parseBeanDefinitionElement(Element ele, @Nullable BeanDefinition containingBean) {
		...
		if (beanDefinition != null) {
			...
			//beanDefinition包装为BeanDefinitionHolder对象
	...
	public AbstractBeanDefinition parseBeanDefinitionElement(
		...
		try {
			...
			//bean标签的子标签lookup-method标签
			parseLookupOverrideSubElements(ele, bd.getMethodOverrides());
			
			//bean标签的子标签replaced-method标签
			parseReplacedMethodSubElements(ele, bd.getMethodOverrides());
			
			//bean标签的子标签constructor-arg标签
			parseConstructorArgElements(ele, bd);
			
			//bean标签的子标签property标签
			parsePropertyElements(ele, bd);
			
			//bean标签的子标签qualifier标签
	...
	public AbstractBeanDefinition parseBeanDefinitionAttributes(Element ele, String beanName,
		...
		//bean标签的factory-method标签
		if (ele.hasAttribute(FACTORY_METHOD_ATTRIBUTE)) {
			bd.setFactoryMethodName(ele.getAttribute(FACTORY_METHOD_ATTRIBUTE));
		}
		//bean标签的factory-bean标签
